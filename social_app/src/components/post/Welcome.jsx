...
function Welcome() {
    return (
        <>
            <div className="bg-dark text-secondary m-5 px-4 py-5 text-center" style={{borderRadius: 20}}>
    <div className="py-5">
      ...
      <div className="col-lg-6 mx-auto">
        ...
        <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
          <button type="button" className="btn btn-outline-info btn-lg px-4 me-sm-3 fw-bold">Get Posts from Server</button>
        </div>
      </div>
    </div>
  </div>
